        ...
        <form method="POST">
            <div class="space-y-12">
                <div class="col-span-full">
                    ...
                    <div class="mt-2">
                        <textarea style="resize: none; height: 200px;" id="body" name="body" rows="10" class="block w-full rounded-md border-0 py-2 px-3 bg-neutral-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-300 sm:text-sm sm:leading-6" placeholder="Type your note..." required><?= htmlspecialchars($note['body'] ?? null) ?></textarea>
                    </div>
